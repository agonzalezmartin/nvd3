...
nv.models.treeDiagram = function() { 
...
nv.models.zoomableCirclePacking = function() { 
...
nv.models.petal = function() { 
	...
	function chart(selection) {
		...
		renderWatch.renderEnd('Chords immediate');
        return chart;
    }
